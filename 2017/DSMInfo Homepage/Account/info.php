<?php
    ...
    if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
        ...
        if (!empty($_GET['user_id'])) {
            $sql = "SELECT id, name, gender, favorite, msg FROM student WHERE id='".$_GET['user_id']."'";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <article>
                    <div class="col-md-9">
                        <?php
                            echo '<div id="articleHeader"><h3>사용자 정보</h3></div>';
                            ...
                            echo '<input type="button" class="btn btn-info" value="뒤로가기" onclick="window.history.back();">';
                            echo '</div>';
                        ?>
                    </div>
                </article>
